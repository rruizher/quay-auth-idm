...
curl -X POST -H 'Authorization: Bearer Ek4EZY5xbFxNGniKALHkBS0mctPzRwKhCxYqXDDt' -H 'Content-Type: application/json' -d '{"name":"finance","email":"cloudadmin@example.com"}'  https://company-registry-quay-quay-enterprise.apps.ocp4.example.com/api/v1/organization/
